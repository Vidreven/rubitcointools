...
describe Keys do
	...
	context 'script_to_address' do
		...
		context 'given a script' do
			...
			it 'return P2SH address' do
				redeem_script = ''
				addr = k.script_to_address redeem_script
				expect(addr).to eql '347N1Thc213QqfYCz3PZkjoJpNv5b14kBd'
			end
		end
	end
